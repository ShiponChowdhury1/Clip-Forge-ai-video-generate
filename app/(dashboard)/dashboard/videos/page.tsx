      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-8 mb-4">
          ...
          <p className="text-gray-500 text-sm">
            ...
            {" of "}
            <span className="text-gray-300 font-medium">{filteredVideos.length}</span>
            {" videos"}
          </p>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-2 bg-[#0D1117] border border-[#1A3155] rounded-lg text-sm text-gray-400 hover:text-white hover:border-[#3B82F6] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-[#1A3155] disabled:hover:text-gray-400 transition-all"
            >
                ...
                <button
                  ...
                  className={`min-w-[36px] h-9 flex items-center justify-center rounded-lg text-sm font-medium transition-all ${
                    currentPage === page
                      ...
                      : "bg-[#0D1117] border border-[#1A3155] text-gray-400 hover:text-white hover:border-[#3B82F6]"
                  }`}
                >
                  {page}
                </button>
