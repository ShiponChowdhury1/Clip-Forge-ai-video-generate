      ...
      <div className="max-w-330 mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 md:py-20">
        ...
        {policy?.updated_at && (
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-3">
            Effective Date: {formatDate(policy.updated_at)}
          </p>
        )}
        <p className="max-w-4xl text-gray-600 dark:text-gray-400 text-sm sm:text-base leading-relaxed mb-8 sm:mb-12">
          ClipForge (&quot;ClipForge,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and AI-powered video generation platform.
        </p>
